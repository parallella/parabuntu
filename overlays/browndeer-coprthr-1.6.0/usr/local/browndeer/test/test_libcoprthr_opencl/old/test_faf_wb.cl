...
barrier(CLK_LOCAL_MEM_FENCE);	b0[gtid] = (0.0f+1.1f)*(+tmp0);
}
...
barrier(CLK_LOCAL_MEM_FENCE);	b0[gtid] = (0.0f+1.1f)*(+tmp0+tmp1);
}
...
barrier(CLK_LOCAL_MEM_FENCE);	b0[gtid] = (0.0f+1.1f)*(+tmp0+tmp1+tmp2);
}
...
barrier(CLK_LOCAL_MEM_FENCE);	b0[gtid] = (0.0f+1.1f)*(+tmp0+tmp1+tmp2+tmp3);
}
...
barrier(CLK_LOCAL_MEM_FENCE);	b0[gtid] = (0.0f+1.1f)*(+tmp0+tmp1+tmp2+tmp3+tmp4);
}
...
barrier(CLK_LOCAL_MEM_FENCE);	b0[gtid] = (0.0f+1.1f)*(+tmp0+tmp1+tmp2+tmp3+tmp4+tmp5);
}
...
barrier(CLK_LOCAL_MEM_FENCE);	b0[gtid] = (0.0f+1.1f)*(+tmp0+tmp1+tmp2+tmp3+tmp4+tmp5+tmp6);
}
...
barrier(CLK_LOCAL_MEM_FENCE);	b0[gtid] = (0.0f+1.1f)*(+tmp0+tmp1+tmp2+tmp3+tmp4+tmp5+tmp6+tmp7);
}
