...
corresponds to the bdt_nbody_tutorial using two GPUs.  The program is 
intended to be used as a tutorial and not designed for performance or 
sophistication.
...
In order to run this program you need two Radeon HD 5870s or a 5970.
