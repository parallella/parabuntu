...
size_t file_sz;
void* pfile;
__mapfile("test_block_float.cl",file_sz,pfile);
...
if (clSetKernelArg(krn,0+1+1,blocksize*sizeof(float),0)) exit(__LINE__);
...
if (clSetKernelArg(krn,0+1+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+2+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+2+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+1+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+2+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+2+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+3+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+3+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+3+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+1+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+2+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+2+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+3+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+3+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+3+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+4+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+4+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+4+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+4+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+1+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+2+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+2+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+3+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+3+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+3+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+4+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+4+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+4+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+4+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+5+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+5+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+5+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+5+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+5+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+1+6,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+2+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+2+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+3+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+3+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+3+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+4+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+4+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+4+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+4+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+5+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+5+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+5+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+5+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+5+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+6+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+6+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+6+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+6+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+6+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,5+6+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+1+7,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+2+6,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+2+6,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+3+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+3+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+3+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+4+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+4+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+4+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+4+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+5+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+5+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+5+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+5+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+5+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+6+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+6+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+6+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+6+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+6+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,5+6+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+7+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+7+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+7+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+7+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+7+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,5+7+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,6+7+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+1+8,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+2+7,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+2+7,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+3+6,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+3+6,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+3+6,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+4+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+4+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+4+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+4+5,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+5+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+5+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+5+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+5+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+5+4,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+6+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+6+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+6+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+6+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+6+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,5+6+3,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+7+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+7+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+7+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+7+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+7+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,5+7+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,6+7+2,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
...
if (clSetKernelArg(krn,0+8+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,1+8+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,2+8+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,3+8+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,4+8+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,5+8+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,6+8+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clSetKernelArg(krn,7+8+1,blocksize*sizeof(float),0)) exit(__LINE__);
if (clEnqueueNDRangeKernel(cmdq,krn,1,0,gws1,lws1,0,0,&ev[0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(int),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
