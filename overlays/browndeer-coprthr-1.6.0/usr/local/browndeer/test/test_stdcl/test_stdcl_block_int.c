...
void* clh = clopen(cp,"test_block_int.cl",CLLD_NOW);
cl_kernel krn;
...
clarg_set_local(cp,krn,0+1+1,blocksize*sizeof(int));
...
clarg_set_local(cp,krn,0+1+2,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
...
clarg_set_local(cp,krn,0+2+1,blocksize*sizeof(int));
clarg_set_local(cp,krn,1+2+1,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
...
clarg_set_local(cp,krn,0+1+3,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
...
clarg_set_local(cp,krn,0+2+2,blocksize*sizeof(int));
clarg_set_local(cp,krn,1+2+2,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
...
clarg_set_local(cp,krn,0+3+1,blocksize*sizeof(int));
clarg_set_local(cp,krn,1+3+1,blocksize*sizeof(int));
clarg_set_local(cp,krn,2+3+1,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
...
clarg_set_local(cp,krn,0+1+4,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
...
clarg_set_local(cp,krn,0+2+3,blocksize*sizeof(int));
clarg_set_local(cp,krn,1+2+3,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
...
clarg_set_local(cp,krn,0+3+2,blocksize*sizeof(int));
clarg_set_local(cp,krn,1+3+2,blocksize*sizeof(int));
clarg_set_local(cp,krn,2+3+2,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
...
clarg_set_local(cp,krn,0+4+1,blocksize*sizeof(int));
clarg_set_local(cp,krn,1+4+1,blocksize*sizeof(int));
clarg_set_local(cp,krn,2+4+1,blocksize*sizeof(int));
clarg_set_local(cp,krn,3+4+1,blocksize*sizeof(int));
if (!clfork(cp,devnum,krn,&ndr,CL_EVENT_NOWAIT))
exit(__LINE__);
if (!clmsync(cp,devnum,bb0,CL_MEM_HOST|CL_EVENT_NOWAIT))
exit(__LINE__);
