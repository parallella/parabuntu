...
)
{
	...
	__local float4 w_hx000[65];
	__local float4 w_hy000[65];
	__local float4 w_hz000[65];
...
)
{
	...
	__local float4 w_ex111[65];
	__local float4 w_ey111[65];
	__local float4 w_ez111[65];
