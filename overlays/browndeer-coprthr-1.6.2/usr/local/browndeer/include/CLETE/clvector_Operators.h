#ifndef _CLVECTOROPERATORS_H
#define _CLVECTOROPERATORS_H
...
inline typename MakeReturn<UnaryNode<FnArcCos,
  typename CreateLeaf<clvector<T1> >::Leaf_t> >::Expression_t
acos(const clvector<T1> & l)
{
  typedef UnaryNode<FnArcCos,
    typename CreateLeaf<clvector<T1> >::Leaf_t> Tree_t;
  return MakeReturn<Tree_t>::make(Tree_t(
    CreateLeaf<clvector<T1> >::make(l)));
}

template<class T1>
inline typename MakeReturn<UnaryNode<FnArcSin,
  typename CreateLeaf<clvector<T1> >::Leaf_t> >::Expression_t
asin(const clvector<T1> & l)
{
...
inline typename MakeReturn<UnaryNode<OpIdentity,
  typename CreateLeaf<clvector<T1> >::Leaf_t> >::Expression_t
PETE_identity(const clvector<T1> & l)
{
...
inline typename MakeReturn<UnaryNode<OpCast<T1>,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
peteCast(const T1&, const clvector<T2> & l)
{
  typedef UnaryNode<OpCast<T1>,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
  return MakeReturn<Tree_t>::make(Tree_t(
    CreateLeaf<clvector<T2> >::make(l)));
}

template<class T1,class T2>
inline typename MakeReturn<BinaryNode<OpAdd,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
operator+(const clvector<T1> & l,const clvector<T2> & r)
{
...
inline typename MakeReturn<BinaryNode<FnLdexp,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
ldexp(const clvector<T1> & l,const clvector<T2> & r)
{
...
inline typename MakeReturn<BinaryNode<FnPow,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
pow(const clvector<T1> & l,const clvector<T2> & r)
{
...
inline typename MakeReturn<BinaryNode<FnFmod,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
fmod(const clvector<T1> & l,const clvector<T2> & r)
{
...
inline typename MakeReturn<BinaryNode<FnArcTan2,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
atan2(const clvector<T1> & l,const clvector<T2> & r)
{
...
operator+(const clvector<T1> & l,const Expression<T2> & r)
{
  typedef BinaryNode<OpAdd,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
...
inline typename MakeReturn<BinaryNode<FnLdexp,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<Expression<T2> >::Leaf_t> >::Expression_t
ldexp(const clvector<T1> & l,const Expression<T2> & r)
{
  typedef BinaryNode<FnLdexp,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
    typename CreateLeaf<Expression<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnPow,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<Expression<T2> >::Leaf_t> >::Expression_t
pow(const clvector<T1> & l,const Expression<T2> & r)
{
  typedef BinaryNode<FnPow,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
    typename CreateLeaf<Expression<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnFmod,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<Expression<T2> >::Leaf_t> >::Expression_t
fmod(const clvector<T1> & l,const Expression<T2> & r)
{
  typedef BinaryNode<FnFmod,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
    typename CreateLeaf<Expression<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnArcTan2,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<Expression<T2> >::Leaf_t> >::Expression_t
atan2(const clvector<T1> & l,const Expression<T2> & r)
{
  typedef BinaryNode<FnArcTan2,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
    typename CreateLeaf<Expression<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<OpAdd,
  ...
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
operator+(const Expression<T1> & l,const clvector<T2> & r)
{
  typedef BinaryNode<OpAdd,
    typename CreateLeaf<Expression<T1> >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnLdexp,
  typename CreateLeaf<Expression<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
ldexp(const Expression<T1> & l,const clvector<T2> & r)
{
  typedef BinaryNode<FnLdexp,
    typename CreateLeaf<Expression<T1> >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnPow,
  typename CreateLeaf<Expression<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
pow(const Expression<T1> & l,const clvector<T2> & r)
{
  typedef BinaryNode<FnPow,
    typename CreateLeaf<Expression<T1> >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnFmod,
  typename CreateLeaf<Expression<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
fmod(const Expression<T1> & l,const clvector<T2> & r)
{
  typedef BinaryNode<FnFmod,
    typename CreateLeaf<Expression<T1> >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnArcTan2,
  typename CreateLeaf<Expression<T1> >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
atan2(const Expression<T1> & l,const clvector<T2> & r)
{
  typedef BinaryNode<FnArcTan2,
    typename CreateLeaf<Expression<T1> >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
operator+(const clvector<T1> & l,const T2 & r)
{
  typedef BinaryNode<OpAdd,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
...
inline typename MakeReturn<BinaryNode<FnLdexp,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<T2 >::Leaf_t> >::Expression_t
ldexp(const clvector<T1> & l,const T2 & r)
{
  typedef BinaryNode<FnLdexp,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
    typename CreateLeaf<T2 >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnPow,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<T2 >::Leaf_t> >::Expression_t
pow(const clvector<T1> & l,const T2 & r)
{
  typedef BinaryNode<FnPow,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
    typename CreateLeaf<T2 >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnFmod,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<T2 >::Leaf_t> >::Expression_t
fmod(const clvector<T1> & l,const T2 & r)
{
  typedef BinaryNode<FnFmod,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
    typename CreateLeaf<T2 >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnArcTan2,
  typename CreateLeaf<clvector<T1> >::Leaf_t,
  typename CreateLeaf<T2 >::Leaf_t> >::Expression_t
atan2(const clvector<T1> & l,const T2 & r)
{
  typedef BinaryNode<FnArcTan2,
    typename CreateLeaf<clvector<T1> >::Leaf_t,
    typename CreateLeaf<T2 >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<OpAdd,
  ...
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
operator+(const T1 & l,const clvector<T2> & r)
{
  typedef BinaryNode<OpAdd,
    typename CreateLeaf<T1 >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnLdexp,
  typename CreateLeaf<T1 >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
ldexp(const T1 & l,const clvector<T2> & r)
{
  typedef BinaryNode<FnLdexp,
    typename CreateLeaf<T1 >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnPow,
  typename CreateLeaf<T1 >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
pow(const T1 & l,const clvector<T2> & r)
{
  typedef BinaryNode<FnPow,
    typename CreateLeaf<T1 >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnFmod,
  typename CreateLeaf<T1 >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
fmod(const T1 & l,const clvector<T2> & r)
{
  typedef BinaryNode<FnFmod,
    typename CreateLeaf<T1 >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<FnArcTan2,
  typename CreateLeaf<T1 >::Leaf_t,
  typename CreateLeaf<clvector<T2> >::Leaf_t> >::Expression_t
atan2(const T1 & l,const clvector<T2> & r)
{
  typedef BinaryNode<FnArcTan2,
    typename CreateLeaf<T1 >::Leaf_t,
    typename CreateLeaf<clvector<T2> >::Leaf_t> Tree_t;
...
where(const clvector<T1> & c,const T2 & t,const T3 & f)
{
...
inline
clvector<T1>& assign(clvector<T1>& lhs,const RHS& rhs)
{
...
template<class T1,class RHS>
inline
clvector<T1>& operator+=(clvector<T1>& lhs,const RHS& rhs)
{
  typedef typename CreateLeaf<RHS>::Leaf_t Leaf_t;
