...
if (err) exit(__LINE__);
double* aa0 = (double*)malloc(size*sizeof(double));
if (!aa0) exit(__LINE__);
double* bb0 = (double*)malloc(size*sizeof(double));
if (!bb0) exit(__LINE__);
double* aa1 = (double*)malloc(size*sizeof(double));
if (!aa1) exit(__LINE__);
double* bb1 = (double*)malloc(size*sizeof(double));
if (!bb1) exit(__LINE__);
double* aa2 = (double*)malloc(size*sizeof(double));
if (!aa2) exit(__LINE__);
double* bb2 = (double*)malloc(size*sizeof(double));
if (!bb2) exit(__LINE__);
double* aa3 = (double*)malloc(size*sizeof(double));
if (!aa3) exit(__LINE__);
double* bb3 = (double*)malloc(size*sizeof(double));
if (!bb3) exit(__LINE__);
double* aa4 = (double*)malloc(size*sizeof(double));
if (!aa4) exit(__LINE__);
double* bb4 = (double*)malloc(size*sizeof(double));
if (!bb4) exit(__LINE__);
double* aa5 = (double*)malloc(size*sizeof(double));
if (!aa5) exit(__LINE__);
double* bb5 = (double*)malloc(size*sizeof(double));
if (!bb5) exit(__LINE__);
double* aa6 = (double*)malloc(size*sizeof(double));
if (!aa6) exit(__LINE__);
double* bb6 = (double*)malloc(size*sizeof(double));
if (!bb6) exit(__LINE__);
double* aa7 = (double*)malloc(size*sizeof(double));
if (!aa7) exit(__LINE__);
double* bb7 = (double*)malloc(size*sizeof(double));
...
cl_mem bufa0 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),aa0,&err);
if (err) exit(__LINE__);
cl_mem bufb0 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),bb0,&err);
if (err) exit(__LINE__);
cl_mem bufa1 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),aa1,&err);
if (err) exit(__LINE__);
cl_mem bufb1 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),bb1,&err);
if (err) exit(__LINE__);
cl_mem bufa2 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),aa2,&err);
if (err) exit(__LINE__);
cl_mem bufb2 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),bb2,&err);
if (err) exit(__LINE__);
cl_mem bufa3 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),aa3,&err);
if (err) exit(__LINE__);
cl_mem bufb3 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),bb3,&err);
if (err) exit(__LINE__);
cl_mem bufa4 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),aa4,&err);
if (err) exit(__LINE__);
cl_mem bufb4 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),bb4,&err);
if (err) exit(__LINE__);
cl_mem bufa5 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),aa5,&err);
if (err) exit(__LINE__);
cl_mem bufb5 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),bb5,&err);
if (err) exit(__LINE__);
cl_mem bufa6 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),aa6,&err);
if (err) exit(__LINE__);
cl_mem bufb6 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),bb6,&err);
if (err) exit(__LINE__);
cl_mem bufa7 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),aa7,&err);
if (err) exit(__LINE__);
cl_mem bufb7 = clCreateBuffer(ctx,CL_MEM_USE_HOST_PTR,size*sizeof(double),bb7,&err);
if (err) exit(__LINE__);
size_t file_sz;
void* pfile;
__mapfile("test_arg_double2.cl",file_sz,pfile);
...
cl_event ev[10];
cl_kernel krn;
double sum,sum_correct;
double tol = pow(10.0,-8+log10((double)size));
...
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(double),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
if (clWaitForEvents(1+1,ev)) exit(__LINE__);
sum_correct = 0;
for(i=0;i<1;++i)
for(j=0;j<1;++j)
sum_correct += (j+1.1)*( (size*(size-1)*1.1)/2 + (1+13.1)*i*size + 0.1*size + size*0.54);
sum = 0;
...
if (clEnqueueReadBuffer(cmdq,bufb0,CL_TRUE,0,size*sizeof(double),bb0,0,0,&ev[1+0])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb1,CL_TRUE,0,size*sizeof(double),bb1,0,0,&ev[1+1])) 
exit(__LINE__);
...
if (clEnqueueReadBuffer(cmdq,bufb1,CL_TRUE,0,size*sizeof(double),bb1,0,0,&ev[1+1])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb2,CL_TRUE,0,size*sizeof(double),bb2,0,0,&ev[1+2])) 
exit(__LINE__);
...
if (clEnqueueReadBuffer(cmdq,bufb2,CL_TRUE,0,size*sizeof(double),bb2,0,0,&ev[1+2])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb3,CL_TRUE,0,size*sizeof(double),bb3,0,0,&ev[1+3])) 
exit(__LINE__);
...
if (clEnqueueReadBuffer(cmdq,bufb3,CL_TRUE,0,size*sizeof(double),bb3,0,0,&ev[1+3])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb4,CL_TRUE,0,size*sizeof(double),bb4,0,0,&ev[1+4])) 
exit(__LINE__);
...
if (clEnqueueReadBuffer(cmdq,bufb4,CL_TRUE,0,size*sizeof(double),bb4,0,0,&ev[1+4])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb5,CL_TRUE,0,size*sizeof(double),bb5,0,0,&ev[1+5])) 
exit(__LINE__);
...
if (clEnqueueReadBuffer(cmdq,bufb5,CL_TRUE,0,size*sizeof(double),bb5,0,0,&ev[1+5])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb6,CL_TRUE,0,size*sizeof(double),bb6,0,0,&ev[1+6])) 
exit(__LINE__);
...
if (clEnqueueReadBuffer(cmdq,bufb6,CL_TRUE,0,size*sizeof(double),bb6,0,0,&ev[1+6])) 
exit(__LINE__);
if (clEnqueueReadBuffer(cmdq,bufb7,CL_TRUE,0,size*sizeof(double),bb7,0,0,&ev[1+7])) 
exit(__LINE__);
